    ...
    <el-row :gutter="20">
      <el-col :sm="24" :lg="24">
        <blockquote class="text-warning" style="font-size: 14px">
          ...
          <br />
          <el-link
            href="https://github.com/18721336535?tab=repositories"
            type="primary"
            target="_blank"
            >https://github.com/18721336535?tab=repositories</el-link
          >
          <br />
          项目地址：
          <el-link href="https://github.com/18721336535?tab=repositories" type="primary" target="_blank"
            >>☛☛点我进入☚☚</el-link
          >
         <br />
      ...
      <el-col :sm="24" :lg="12" style="padding-left: 20px">
        ...
        <p>
          <el-button
            ...
            icon="Cloudy"
            plain
            @click="goTarget('https://github.com/18721336535?tab=repositories')"
            >访问GitHub</el-button
          >
          <el-button
            icon="HomeFilled"
    ...
    <el-row :gutter="20">
      <el-col :xs="24" :sm="24" :md="12" :lg="8">
        <el-card class="update-log">
          ...
          <div class="body">
            <p>
              <i class="el-icon-user-solid"></i> QQ群：<s></s>
            </p>
            <p>
